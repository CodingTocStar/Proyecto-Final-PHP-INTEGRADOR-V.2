...
<html lang="en">
  <head>
    ...
    <title>PROYECTO FINAL V2 - TABLA DE PUBLICO EN VIVO</title>
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown mx-3">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <li><a class="dropdown-item active fw-medium" aria-current="page" href="publicoEnVivo.php">Publico en vivo</a></li>
...
<table class="table w-75 mx-auto mt-4 table-striped">
  ...
  <tbody class="table-warning text-center">
    <?php
      //TRAIGO LA BBDD
        $queryPublicoVivo = "SELECT * FROM publico_vivo";

        $consultaPublicoVivo = mysqli_query ($conexion, $queryPublicoVivo);
        

      //BUCLE

        while($listadoPublicoVivo = mysqli_fetch_array($consultaPublicoVivo)){
    ?>
        
    <tr>
      <td scope="row"><?php echo $listadoPublicoVivo['nombre']?></td>  <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->

      <td scope="row"><?php echo $listadoPublicoVivo['apellido']?></td> <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->

      <td scope="row"><?php echo $listadoPublicoVivo['mail']?></td> <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->

      <td scope="row"><?php echo $listadoPublicoVivo['Cantidad de entradas']?></td> <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->

      <td scope="row"><?php echo $listadoPublicoVivo['Categoria']?></td> <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->
    </tr>
