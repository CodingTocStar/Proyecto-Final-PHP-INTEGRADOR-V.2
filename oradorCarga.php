...
<html lang="en">
  <head>
    ...
    <title>Carga de datos de oradores</title>
 ...
 <?php
    ...
    //SERVIDOR
      ...
      // CREO LAS VARIABLES DONDE SACO LOS DATOS

        $nombre = $_POST['nombre'];
        $apellido = $_POST['apellido'];
        $usuario = $_POST['mail'];
        $contraseña = $_POST['password'];
        $tituloCharla = $_POST['charla'];

      // QUERYS DE INSERCION

        $queryInsertar = "INSERT INTO oradores VALUES ('id_orador ', '$nombre', '$apellido', '$usuario', '$contraseña', '$tituloCharla')";
      ...
      //VERIFICO CONEXION
        if(!$queryInsertar){
            ...
            echo '<h2 style="color:yellow">Cargaste tu usuario con EXITO a la base de datos!</h2>';
    ...
    <button class="btn btn-primary ms-2"><a class="text-white" href="orador.php">Volver</a></button>
