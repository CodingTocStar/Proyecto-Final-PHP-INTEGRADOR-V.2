...
<html lang="en">
  <head>
    ...
    <title>PROYECTO FINAL V2 - REGISTRO DE AUDIENCIA</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark border-top border-bottom border-warning border-2">
    ...
    <!-- METO EL PHP PARA REGISTRAR A LA AUDIENCIA -->


    <!-- CARGA DE PARTICIPANTES ONLINE -->
    <?php
      //LOCAL
      ...
      //QUERY de INSERCION
        ...
        $queryInsertar = "INSERT INTO audiencia_virtual VALUES ('id_virtual','$nombre', '$apellido', '$mail', '$contraseña')";
      ...
      //VERIFICACION 
        if(!$queryInsertar){
          ...
          echo "Error, no se conecto a la BBDD " . mysqli_errno($conexion);

        } else {

          echo "<br>";

          echo '<h2 style="color:yellow">Te inscribiste con EXITO a la conferencia!</h2>';
    ...
    <footer class="mt-5 bg-black text-white fw-bold border-top-3 border border-light">
