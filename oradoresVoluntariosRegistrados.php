...
<html lang="en">
  <head>
    ...
    <title>PROYECTO FINAL V2 - ORADORES VOLUNTARIOS REGISTRADOS</title>
  ...
  <body>
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown mx-3">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <li><a class="dropdown-item active fw-medium" aria-current="page" href="oradoresVoluntariosRegistrados.php">Oradores voluntarios registrados</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
    ...
    <!--  METO LA TABLA -->
          ...
          <!-- 1)CONEXION  - listo
              2) VERIFICACION  - listo
              3) TABLA HTML  - listo
              4) CONEXION BBDD  - listo
              5) BUCLE  - listo
          -->
    ...
    <table class="table w-75 mx-auto mt-4 table-striped">
        <thead>
            ...
            <th scope="col">Titulo de la charla</th>
            </tr>
        </thead>
        <tbody class="table-warning text-center">
            <?php
            //TRAIGO LA BBDD
                $queryOradores = "SELECT * FROM oradores";

                $consultaOradores = mysqli_query ($conexion, $queryOradores);
                

            //BUCLE

                while($listadoOradores = mysqli_fetch_array($consultaOradores)){
            ?>
                
            <tr>
            <td scope="row"><?php echo $listadoOradores['nombre']?></td>  <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->

            <td scope="row"><?php echo$listadoOradores['apellido']?></td> <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->

            <td scope="row"><?php echo $listadoOradores['mail']?></td> <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->

            <td scope="row"><?php echo $listadoOradores['password']?></td> <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->

            <td scope="row"><?php echo $listadoOradores['titulo charla']?></td> <!--  ES EL NOMBRE QUE TIENE EN LA BASE DE DATOS  -->
